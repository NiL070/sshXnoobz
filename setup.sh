...
sleep 2
wget https://raw.githubusercontent.com/NiL070/sshXnoobz/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Cert
printf '\e[0;32mINSTALLING CERT...\e[0m'
sleep 1
wget https://raw.githubusercontent.com/NiL070/sshXnoobz/main/install/ins-cert.sh && chmod +x ins-cert.sh && screen -S ins-cert ./ins-cert.sh
printf '\e[0;32mDONE INSTALLING XRAY CORE\e[0m'
clear
#install ohp-server
printf '\e[0;32mINSTALLING OHP...\e[0m'
sleep 1
wget https://raw.githubusercontent.com/NiL070/sshXnoobz/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/NiL070/sshXnoobz/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/NiL070/sshXnoobz/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
printf '\e[0;32mDONE INSTALLING OHP PORT\e[0m'
clear
#install websocket
printf '\e[0;32mINSTALLING WEBSOCKET...\e[0m'
wget https://raw.githubusercontent.com/NiL070/sshXnoobz/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
printf '\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m'
clear
#install SET-BR
printf '\e[0;32mINSTALLING SET-BR...\e[0m'
sleep 1
wget https://raw.githubusercontent.com/NiL070/sshXnoobz/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
printf '\e[0;32mDONE INSTALLING SET-BR...\e[0m'
clear
rm -f /root/ssh-vpn.sh
rm -f /root/ins-cert.sh
rm -f /root/set-br.sh
rm -f /root/ohp.sh
