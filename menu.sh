...
clear
echo -e "\e[$text PREMIUM SCRIPT MODDED BY NILPHREAKZ"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
...
echo -e   "  \e[$number (•2)\e[m \e[$below PANEL NOOBZVPN\e[m"            
echo -e   "  \e[$number (•3)\e[m \e[$below SYSTEM MENU\e[m"
echo -e   "  \e[$number (•4)\e[m \e[$below CHANGE PORT\e[m"
echo -e   "  \e[$number (•5)\e[m \e[$below CHECK RUNNING\e[m"
echo -e   "  \e[$number (•6)\e[m \e[$below CLEAR LOG VPS\e[m"
echo -e   "  \e[$number (•7)\e[m \e[$below INFO ALL PORT\e[m"
echo -e   "  \e[$number (•8)\e[m \e[$below DAILY BANDWIDTH\e[m"
echo -e   "  \e[$number (•9)\e[m \e[$below MONTHLY BANDWIDTH\e[m"
echo -e   "  \e[$number (10)\e[m \e[$below REBOOT VPS\e[m"
echo -e   "  \e[$number (11)\e[m \e[$below LOG OUT\e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$below SERVICE SSH/OVPN/NOOBZVPN ONLY"
